...
HRESULT Cube::CreateShaders(ID3D11Device* m_pDevice)
{
    ...
    if (!vs.Initialize(m_pDevice, L"VertexShader.hlsl"))
    {
        return S_FALSE;
    }
    ...
    if (!ps.Initialize(m_pDevice, L"PixelShader.hlsl"))
    {
        return S_FALSE;
    }
...
HRESULT Sphere::CreateShaders(ID3D11Device* m_pDevice)
{
    ...
    if (!vs.Initialize(m_pDevice, L"SphereVS.hlsl"))
    {
        return S_FALSE;
    }
    ...
    if (!ps.Initialize(m_pDevice, L"SpherePS.hlsl"))
    {
        return S_FALSE;
    }
...
HRESULT Square::CreateShaders(ID3D11Device* m_pDevice)
{
    ...
    if (!vs.Initialize(m_pDevice, L"SquareVS.hlsl"))
    {
        return S_FALSE;
    }
    ...
    if (!ps.Initialize(m_pDevice, L"SquarePS.hlsl"))
    {
        return S_FALSE;
    }
